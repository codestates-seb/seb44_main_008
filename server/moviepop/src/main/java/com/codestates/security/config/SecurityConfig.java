...
public class SecurityConfig extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST, "/find-id").permitAll()
                .antMatchers(HttpMethod.POST, "/verification-code").permitAll()
                .antMatchers(HttpMethod.POST, "/verification").permitAll()
                .antMatchers(HttpMethod.PATCH, "/new-password").permitAll()
